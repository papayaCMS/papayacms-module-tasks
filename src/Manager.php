<?php
/**
* Implementes a generic task list for confirmable actions
*
...
* @subpackage Tasks
* @version $Id: Manager.php 39576 2014-03-17 09:47:18Z weinert $
*/
...
class PapayaModuleTasksManager extends PapayaObject {
  ...
  */
   ...
   *
   * @param string $id
   * @return null|\PapayaModuleTasksItem
   */
   ...
   * Confirm a task
   *
   * Loads the task, calls the specified connector and sets it to confirmed if the confirmTask
   * method of the connector returned TRUE.
   *
   * @param string $id
   * @return bool
   */
  ...
  */
  public function getTaskPlugin($guid) {
    return $this->papaya()->plugins->get($guid, $this);
  }
}